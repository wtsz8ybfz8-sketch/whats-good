 ...
 */}
 ...
 <div className="action-bar fixed bottom-[calc(var(--tabbar-h)+env(safe-area-inset-bottom))] left-0 right-0 z-40 px-5 pb-4 pt-3 flex justify-center md:static md:bottom-auto md:bg-transparent md:border-0 md:shadow-none md:px-0 md:pt-8 md:pb-4 md:z-auto">
 <button
